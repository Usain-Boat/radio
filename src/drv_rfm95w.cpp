...
#include "drv_rfm95w_fsk.h"
#include "drv_rfm95w_lora.h"
 ...
 * Constructor
 */
SX1276_Radio::SX1276_Radio(PinName spi_mosi,
                           PinName spi_miso,
                           PinName spi_sclk,
                           PinName nss,
                           PinName reset,
...
#ifdef MBED_CONF_RTOS_PRESENT
    irq_thread.start(mbed::callback(this, &SX1276_Radio::rf_irq_task));
#endif
}
 ...
 */
void SX1276_Radio::init_radio(radio_events_t *events)
{
 ...
 */
bool SX1276_Radio::check_rf_frequency(uint32_t frequency)
{
 ...
 */
uint8_t SX1276_Radio::get_status(void)
{
 ...
 */
void SX1276_Radio::set_channel(uint32_t freq)
{
 ...
 */
uint32_t SX1276_Radio::random(void)
{
    uint8_t  i;
    uint32_t rnd = 0;
 ...
 */
void SX1276_Radio::set_rx_config(radio_modems_t modem, uint32_t bandwidth,
 ...
 * to send
 */
void SX1276_Radio::set_tx_config(radio_modems_t modem, int8_t power,
 ...
 * duty cycling.
 */
uint32_t SX1276_Radio::time_on_air(radio_modems_t modem, uint8_t pkt_len)
{
    uint32_t airTime = 0;
 ...
 */
void SX1276_Radio::send(uint8_t *buffer, uint8_t size)
{
 ...
 */
void SX1276_Radio::standby(void)
{
    tx_timeout_timer.detach();
    rx_timeout_timer.detach();
 ...
 */
void SX1276_Radio::receive(uint32_t timeout)
{
    switch (_rf_settings.modem)
    {
        case MODEM_FSK:
    ...
    if (timeout != 0)
    {
        rx_timeout_timer.attach_us(
                callback(this, &SX1276_Radio::timeout_irq_isr),
                timeout * 1e3);
    }
 ...
 *
 */
bool SX1276_Radio::perform_carrier_sense(radio_modems_t modem,
                                         uint32_t freq,
 ...
 */
void SX1276_Radio::set_public_network(bool enable)
{
    set_modem(MODEM_LORA);
 ...
 */
void SX1276_Radio::set_max_payload_length(radio_modems_t modem, uint8_t max)
{
    set_modem(modem);
 ...
 */
void SX1276_Radio::set_tx_continuous_wave(uint32_t freq, int8_t power,
                                          uint16_t time)
{
    uint8_t reg_val;
    ...
    tx_timeout_timer.attach_us(callback(this, &SX1276_Radio::timeout_irq_isr), time * 1e3);
 ...
 */
void SX1276_Radio::rf_irq_task(void)
{
    for (;;)
    {
 ...
 */
void SX1276_Radio::write_to_register(uint8_t addr, uint8_t data)
{
 ...
 */
void SX1276_Radio::write_to_register(uint8_t addr, uint8_t *data, uint8_t size)
{
    // set chip-select low
    _chip_select = 0;
 ...
 */
uint8_t SX1276_Radio::read_register(uint8_t addr)
{
    uint8_t data;
 ...
 */
void SX1276_Radio::read_register(uint8_t addr, uint8_t *buffer, uint8_t size)
{
    // set chip-select low
    _chip_select = 0;
 ...
 */
void SX1276_Radio::write_fifo(uint8_t *buffer, uint8_t size)
{
 ...
 */
void SX1276_Radio::read_fifo(uint8_t *buffer, uint8_t size)
{
 ...
 */
void SX1276_Radio::set_operation_mode(uint8_t mode)
{
 ...
 */
void SX1276_Radio::set_modem(uint8_t modem)
{
 ...
 */
void SX1276_Radio::set_sx1276_variant_type()
{
 ...
 */
void SX1276_Radio::setup_registers()
{
 ...
 * default values.
 */
void SX1276_Radio::rx_chain_calibration(void)
{
 ...
 */
uint8_t SX1276_Radio::get_fsk_bw_reg_val(uint32_t bandwidth)
{
    uint8_t i;
...
uint8_t SX1276_Radio::get_pa_conf_reg(uint32_t channel)
{
 ...
 */
void SX1276_Radio::set_rf_tx_power(int8_t power)
{
 ...
 */
void SX1276_Radio::transmit(uint32_t timeout)
{
    switch (_rf_settings.modem)
    {
    ...
    tx_timeout_timer.attach_us(callback(this,
                                        &SX1276_Radio::timeout_irq_isr), timeout * 1e3);
    set_operation_mode(RF_OPMODE_TRANSMITTER);
}
 ...
 */
int16_t SX1276_Radio::get_rssi(radio_modems_t modem)
{
    int16_t rssi = 0;
 ...
 */
void SX1276_Radio::set_low_power_mode()
{
 ...
 */
void SX1276_Radio::setup_interrupts()
{
    _dio0_ctl.rise(callback(this, &SX1276_Radio::dio0_irq_isr));
    _dio1_ctl.rise(callback(this, &SX1276_Radio::dio1_irq_isr));
    _dio2_ctl.rise(callback(this, &SX1276_Radio::dio2_irq_isr));
    _dio3_ctl.rise(callback(this, &SX1276_Radio::dio3_irq_isr));
    if (_dio4_pin != NC)
    {
        _dio4_ctl.rise(callback(this, &SX1276_Radio::dio4_irq_isr));
    }
    if (_dio5_pin != NC)
    {
        _dio5_ctl.rise(callback(this, &SX1276_Radio::dio5_irq_isr));
    }
}
 ...
 * radio mode
 */
void SX1276_Radio::set_antenna_switch(uint8_t mode)
{
 ...
 ****************************************************************************/
void SX1276_Radio::dio0_irq_isr()
{
#ifdef MBED_CONF_RTOS_PRESENT
...
void SX1276_Radio::dio1_irq_isr()
{
#ifdef MBED_CONF_RTOS_PRESENT
...
void SX1276_Radio::dio2_irq_isr()
{
#ifdef MBED_CONF_RTOS_PRESENT
...
void SX1276_Radio::dio3_irq_isr()
{
#ifdef MBED_CONF_RTOS_PRESENT
...
void SX1276_Radio::dio4_irq_isr()
{
#ifdef MBED_CONF_RTOS_PRESENT
...
void SX1276_Radio::dio5_irq_isr()
{
#ifdef MBED_CONF_RTOS_PRESENT
...
// our timers
void SX1276_Radio::timeout_irq_isr()
{
#ifdef MBED_CONF_RTOS_PRESENT
...
void SX1276_Radio::handle_dio0_irq()
{
...
void SX1276_Radio::handle_dio1_irq()
{
    switch (_rf_settings.state)
    {
        case RF_RX_RUNNING:
...
void SX1276_Radio::handle_dio2_irq(void)
{
    switch (_rf_settings.state)
    {
        case RF_RX_RUNNING:
...
void SX1276_Radio::handle_dio3_irq(void)
{
    switch (_rf_settings.modem)
    {
        case MODEM_FSK:
...
void SX1276_Radio::handle_dio4_irq(void)
{
...
void SX1276_Radio::handle_dio5_irq()
{
    switch (_rf_settings.modem)
    {
        case MODEM_FSK:
...
void SX1276_Radio::handle_timeout_irq()
{
    switch (_rf_settings.state)
    {
        case RF_RX_RUNNING:
...
bool SX1276_Radio::self_test()
{
    return read_register(0x42) != 0;
}
// EOF
